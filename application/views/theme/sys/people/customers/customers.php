 ...
 * Created on: 10/30/2019 10:07 PM
 */
?>
    ...
    <div class="btn-group float-md-right" role="group">
        <div class="btn-group" role="group">
            <a class="btn btn-outline-blue-grey"
               modal-toggler="true" data-target="#remoteModal2" data-remote="<?= sysUrl('addCustomer') ?>"> Add
                Customer
            </a>
        </div>
    </div>
...
<script>
    ...
    function geTableData() {
        Table = $('.serverSide-table').DataTable({
            ...
            'aoColumns': [{mData: "name"}, {mData: "email"}, {mData: "contact"}, {mData: "address"}, {mData: "addedBy"},
